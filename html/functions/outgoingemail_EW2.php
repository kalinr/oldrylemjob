...
function sendOrderEmail($orderid)
{
	...
	$message = '<img src="http://www.imaginecrafts.com/images/email-logo.png" /><br /><br /><font face="Arial">Thank you for placing your order with IMAGINE Crafts.';	
	...
	if($row['CCTYPE'] != "")
		$message .= "<br /><br />Credit Card: ".$row['CCTYPE']." xxxx-xxxx-xxxx-".$row['LAST4CC'];
	else	
