...
<? if($content['ID'] != 77){ ?>
<p>
<a href="/<? echo str_replace("/shipping","",$content['MOD_NAME']); ?>/<? echo $query_array[0]; ?>" ?>/<? echo $query_array[0]; ?>" ?>/<? echo $query_array[0]; ?>" ?>/<? echo $query_array[0]; ?>" ?>/<? echo $query_array[0]; ?>" ?>/<? echo $query_array[0]; ?>" ?>/<? echo $query_array[0]; ?>" ?>/<? echo $query_array[0]; ?>" ?>/<? echo $query_array[0]; ?>" ?>/<? echo $query_array[0]; ?>">Back To Profile</a></p>
<? } ?>